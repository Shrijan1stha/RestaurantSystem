...
from .serializers import TableSerializer, MenuSerializer, CategorySerializer, OrderSerializer, WaiterSerializer, ReceptionSerializer
...
class WaiterApiView(ModelViewSet):
    queryset = Waiter.objects.all()
    serializer_class = WaiterSerializer

class ReceptionApiView(ModelViewSet):
